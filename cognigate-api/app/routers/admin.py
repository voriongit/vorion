...
WARNING: These endpoints should be protected by authentication
...
async def get_circuit_history(limit: int = 10) -> dict:
...
async def manual_circuit_halt(request: ManualHaltRequest) -> dict:
    """
...
async def manual_circuit_reset() -> dict:
    """
...
async def halt_entity(request: EntityHaltRequest) -> dict:
    """
...
async def unhalt_entity(request: EntityUnhaltRequest) -> dict:
    """
...
async def cascade_halt_entity(request: CascadeHaltRequest) -> dict:
    """
...
async def get_all_velocity_stats() -> dict:
    """
...
async def get_entity_velocity(entity_id: str) -> dict:
    """
...
async def throttle_entity(request: ThrottleRequest) -> dict:
    """
...
async def unthrottle_entity(request: EntityUnhaltRequest) -> dict:
    """
