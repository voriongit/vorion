...
if not is_safe:
  ...
  {
    term: 'ACI Spec',
    definition: 'Agent Capability Interface Specification - An open standard (Apache 2.0) for AI agent governance defining 6 trust tiers (T0-T5) on a 0-1000 scale, capability gating, and policy enforcement. Published as @vorionsys/aci-spec on npm.',
    level: 'intermediate',
    category: 'protocols',
  ...
  {
    term: 'Trust Tiers',
    definition: 'Six classification levels (T0-T5) in the ACI specification: T0 Sandbox (0-99), T1 Provisional (100-299), T2 Established (300-499), T3 Trusted (500-699), T4 Verified (700-899), T5 Certified (900-1000). Each tier unlocks additional agent capabilities.',
    level: 'expert',
    category: 'protocols',
    tags: ['trust', 'vorion', 'aci'],
  },
  {
    term: 'OAuth 2.0',
  ...
  {
    term: 'Trust Score',
    definition: 'A 0-1000 numerical measure of an AI agent\'s trustworthiness in the ACI specification. Calculated from behavioral signals including task completion, security compliance, and interaction quality.',
    level: 'intermediate',
    category: 'safety',
    tags: ['trust', 'governance', 'aci'],
    slug: 'trust-score',
    relatedTerms: ['Trust Tier', 'Signal', 'Trust Decay', 'ACI Spec'],
  },
  {
    term: 'Capability Gating',
    definition: 'Restricting AI agent actions based on trust level in the ACI spec. Each Trust Tier (T0-T5) unlocks specific capabilities, from sandboxed access at T0 to full autonomy at T5. Prevents untrusted agents from performing high-risk actions.',
    level: 'intermediate',
    category: 'safety',
    tags: ['safety', 'access-control', 'aci'],
    slug: 'capability-gating',
    relatedTerms: ['Trust Tier', 'Trust Score', 'ACI Spec'],
  },
  {
    term: 'Trust Tier',
    definition: 'Six classification levels (T0-T5) in the ACI spec: T0 Sandbox (0-99), T1 Provisional (100-299), T2 Established (300-499), T3 Trusted (500-699), T4 Verified (700-899), T5 Certified (900-1000). Each tier unlocks additional agent capabilities.',
    level: 'intermediate',
    category: 'safety',
    tags: ['trust', 'governance', 'aci'],
    slug: 'trust-tier',
    relatedTerms: ['Trust Score', 'Capability Gating', 'ACI Spec'],
  },
  {
    term: 'Trust Decay',
    ...
    tags: ['trust', 'governance', 'aci'],
    slug: 'trust-decay',
    relatedTerms: ['Trust Score', 'Accelerated Decay', 'Signal', 'ACI Spec'],
  },
  {
    ...
    level: 'expert',
    category: 'safety',
    tags: ['trust', 'security', 'aci'],
    slug: 'accelerated-decay',
    relatedTerms: ['Trust Decay', 'Trust Score', 'Signal', 'ACI Spec'],
  },
  {
    term: 'Proof Chain',
    ...
    level: 'expert',
    category: 'safety',
    tags: ['audit', 'security', 'aci', 'cryptography'],
    slug: 'proof-chain',
    relatedTerms: ['Audit Trail', 'ACI Spec', 'Signal'],
  },
  {
    term: 'Signal',
    ...
    level: 'intermediate',
    category: 'safety',
    tags: ['trust', 'metrics', 'aci'],
    slug: 'signal',
    relatedTerms: ['Trust Score', 'Trust Decay', 'ACI Spec'],
  },
  {
